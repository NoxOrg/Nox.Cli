module "heimdall_<microservice-name>_prod_variables" {
  ...
  variable_params = {
    ...
    we_var01 = {
      ...
      workspace_id    = module.heimdall_<microservice-name>_workspaces.workspaces["<microservice-name>_prod_we"].id
      hcl             = null
      sensitive       = null
    }
    we_var02 = {
    ...
    we_var07 = {
      key             = "k8s_namespace"
      value           = "<microservice-friendly-name>-prod"
      category        = "terraform"
    ...
    ne_var01 = {
      ...
      description     = "Name of the environment."
      variable_set_id = null
      workspace_id    = module.heimdall_<microservice-name>_workspaces.workspaces["<microservice-name>_prod_ne"].id
      hcl             = null
      sensitive       = null
    }
    ne_var02 = {
